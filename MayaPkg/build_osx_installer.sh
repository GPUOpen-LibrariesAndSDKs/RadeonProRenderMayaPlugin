...
xcodebuild -scheme "Release 2017" -project ./RadeonProRender.xcodeproj clean
...
xcodebuild -quiet -scheme "Release 2017" -project ./RadeonProRender.xcodeproj -UseModernBuildSystem=NO
if test $? -eq 0
then
	echo "Release 2017 built successfully"
else
	echo "Release 2017 failed to build"
	popd
	exit 1	
fi
...
if test $? -eq 0
then
	echo "Release 2018 built successfully"
else
	echo "Release 2018 failed to build"
	popd
	exit 1
fi
