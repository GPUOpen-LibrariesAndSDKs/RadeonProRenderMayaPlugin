...
void formSelect::BuildRegistrationLink()
{
	*outmsg << "BuildRegistrationLink begin..." << endl;
	...
	/* Link must look like : */
	//"https://feedback.amd.com/se/5A1E27D23E8EC664?registrationid=5A1E27D27D97ECF5&appname=blender&autodeskmaya=2016&frversion=1.6.30&os=win6.1.7601&gfxcard=AMD_FirePro_W8000__FireGL_V_&driverversion=15.201.2401.0"
...
#define CHECK_DONE_BY_APP_INSTALLER 1
    ...
    if (displaWarningMessage_incompatibleOS || displaWarningMessage_cantGetInfo)
    {
