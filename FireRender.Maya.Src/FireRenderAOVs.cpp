	...
	m_renderViewAOVId(RPR_AOV_COLOR)
{
	...
	m_aovs.push_back(std::shared_ptr<FireRenderAOV>(new FireRenderAOV(RPR_AOV_COLOR, "aovColor", "Color", "color",
				{ { "R", "G", "B", "A" },{ TypeDesc::FLOAT, TypeDesc::VEC4, TypeDesc::COLOR } })));

	m_aovs.push_back(std::shared_ptr<FireRenderAOV>(new FireRenderAOV(RPR_AOV_OPACITY, "aovOpacity", "Opacity", "opacity",
				{ { "R", "G", "B" },{ TypeDesc::FLOAT, TypeDesc::VEC3, TypeDesc::COLOR } })));

	m_aovs.push_back(std::shared_ptr<FireRenderAOV>(new FireRenderAOV(RPR_AOV_WORLD_COORDINATE, "aovWorldCoordinate", "World Coordinate", "world_coordinate",
				{ { "X", "Y", "Z" },{ TypeDesc::FLOAT, TypeDesc::VEC3, TypeDesc::POINT } })));

	m_aovs.push_back(std::shared_ptr<FireRenderAOV>(new FireRenderAOV(RPR_AOV_UV, "aovUV", "UV", "uv",
				{ { "U", "V", "W" },{ TypeDesc::FLOAT, TypeDesc::VEC3, TypeDesc::POINT } })));

	m_aovs.push_back(std::shared_ptr<FireRenderAOV>(new FireRenderAOV(RPR_AOV_MATERIAL_IDX, "aovMaterialIndex", "Material Index", "material_index",
				{ { "R", "G", "B" },{ TypeDesc::FLOAT, TypeDesc::VEC3, TypeDesc::COLOR } })));

	m_aovs.push_back(std::shared_ptr<FireRenderAOV>(new FireRenderAOV(RPR_AOV_GEOMETRIC_NORMAL, "aovGeometricNormal", "Geometric Normal", "geometric_normal",
				{ { "X", "Y", "Z" },{ TypeDesc::FLOAT, TypeDesc::VEC3, TypeDesc::NORMAL } })));

	m_aovs.push_back(std::shared_ptr<FireRenderAOV>(new FireRenderAOV(RPR_AOV_SHADING_NORMAL, "aovShadingNormal", "Shading Normal", "shading_normal",
				{ { "X", "Y", "Z" },{ TypeDesc::FLOAT, TypeDesc::VEC3, TypeDesc::NORMAL } })));

	m_aovs.push_back(std::shared_ptr<FireRenderAOVDepth>(new FireRenderAOVDepth(RPR_AOV_DEPTH, "aovDepth", "Depth", "depth",
				{ { "Z" },{ TypeDesc::FLOAT } })));

	m_aovs.push_back(std::shared_ptr<FireRenderAOV>(new FireRenderAOV(RPR_AOV_OBJECT_ID, "aovObjectId", "Object ID", "object_id",
				{ { "R", "G", "B" },{ TypeDesc::FLOAT, TypeDesc::VEC3, TypeDesc::COLOR } })));

	m_aovs.push_back(std::shared_ptr<FireRenderAOV>(new FireRenderAOV(RPR_AOV_OBJECT_GROUP_ID, "aovObjectGroupId", "Object Group ID", "object_group_id",
				{ { "R", "G", "B" },{ TypeDesc::FLOAT, TypeDesc::VEC3, TypeDesc::COLOR } })));

	m_aovs.push_back(std::shared_ptr<FireRenderAOV>(new FireRenderAOV(RPR_AOV_SHADOW_CATCHER, "aovShadowCatcher", "Shadow", "shadow",
				{ { "R", "G", "B" },{ TypeDesc::FLOAT, TypeDesc::VEC3, TypeDesc::COLOR } })));

	m_aovs.push_back(std::shared_ptr<FireRenderAOV>(new FireRenderAOV(RPR_AOV_BACKGROUND, "aovBackground", "Background", "background",
	{ { "R", "G", "B" },{ TypeDesc::FLOAT, TypeDesc::VEC3, TypeDesc::COLOR } })));
